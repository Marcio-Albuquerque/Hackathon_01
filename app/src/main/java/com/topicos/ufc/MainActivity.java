...
public class MainActivity extends Activity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        intent1 = new Intent(this, Maps1Activity.class); // Uma intent para Classa do Quiz Química
        intent2 = new Intent(this, Maps2Activity.class); // Uma intent para Classa o Canhão Química
